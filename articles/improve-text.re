...
どこで文章が切れるのか全くわかりません。ここでは2文目に注目してください。@<code>{Mac}が文中の主語になっています。ただこのままでは、文章内の動詞は@<code>{対象外としています}となってしまいます。
...
この例は、意味は通じます。そこまで読みづらいと思わないかもしれません。しかし、これはコードブロック内でわざと折り返しているからです。試しに組版形式で記載してみます。
...
この文章だけでは「で、結局Logstashってなんやねん」と感じてしまいますよね。
...
この観点を実施するときは、@<b>{先に述べた推敲を行った1日後}に行うようにします。書いた直後に見直しをかけると、頭の中で内容を補完してしまいます。
原稿を寝かせて置くことで、「言いたかったことと違う」と気付きやすくなります。
