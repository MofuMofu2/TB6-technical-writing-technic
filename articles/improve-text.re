...
言葉の使い方・文章の並べ方・句読点の多さによって、伝わってくる内容が全く違うことが重要なのです。

はじめの文章は「？？？」と思う点がたくさんあるように感じたのではないでしょうか。
「データの内訳に応じて円が別れていきます」と言われて、「Pie Chartを使うと円グラフが描ける」とすぐ解釈できるでしょうか。

「？？？」という感情が読者に蓄積されると、本に対する印象は「読みにくい本」となってしまいます。こうなると、あなたの伝えたいことは3割程度しか伝わりません。
